...
**Brennan Klein** is core faculty at the Network Science Institute and Assistant Teaching Professor in the Department of Physics at Northeastern University, and program director of the MS in Complex Network Analysis. He directs the Complexity & Society Lab, which works on (1) information, emergence, and inference in complex systems, and (2) public health and public safety. In 2023 he received the René Thom Young Researcher Award. He received a PhD in Network Science from Northeastern in 2020 and a BA in Cognitive Science from Swarthmore College in 2014. Website: [brennanklein.com](https://brennanklein.com).
